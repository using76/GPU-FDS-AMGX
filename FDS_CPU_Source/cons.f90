...
INTEGER, PARAMETER :: AMGX_FLAG=3                                !< Integer matrix solver library flag for NVIDIA AmgX GPU solver
#ifdef WITH_AMGX
INTEGER :: ULMAT_SOLVER_LIBRARY=AMGX_FLAG                        !< Integer ULMAT library flag (defaults to AmgX when available)
#else
